...
def reg():
    ...
    r = requests.get('https://raw.githubusercontent.com/SubhanXKhan/KHAN-XD/main/server.txt').text
    if to in r:
        ...
        print ' \x1b[1;91mCopy the id and send to admin'
...
def reg2():
    ...
    sav.write(id)
    sav.close()
    raw_input('\x1b[1;91m Press enter to check Approval ')
    reg()
...
def ip():
    ...
    time.sleep(1)
    print '\x1b[1;91m Your country: ' + country
    time.sleep(1)
    print '\x1b[1;98m Your region: ' + regi
    time.sleep(1)
...
def log_menu_s():
    s = raw_input(' \x1b[1;91m\xe2\x95\xb0\xe2\x94\x80Subhan\xe2\x9e\xa4 ')
    if s == '1':
        log_fb()
    elif s == '2':
        log_token()
...
def menu():
    ...
    try:
        ...
        print ''
        raw_input(' \x1b[1;91mPress enter after turning on mobile data/wifi ')
        menu()
...
def menu_s():
    ms = raw_input('\x1b[1;91m\xe2\x95\xb0\xe2\x94\x80Subhan\xe2\x9e\xa4 ')
    if ms == '1':
        auto_crack()
    elif ms == '2':
        choice_crack()
...
def a_s():
    ...
    cps = []
    oks = []
    a_s = raw_input(' \x1b[1;91m\xe2\x95\xb0\xe2\x94\x80Subhan\xe2\x9e\xa4 ')
    if a_s == '1':
        os.system('clear')
        print logo
    ...
    time.sleep(0.5)
    print 47 * '-'
    print '\t\x1b[1;94mSHBHAN King Of Facebook\x1b[1;91m'
    print 47 * '-'
...
def crack_b():
    ...
    try:
        ...
        os.system('clear')
        print logo
        print '\t File Not Found \x1b[0;91m'
        time.sleep(1)
        log_menu()
...
def c_s():
    ...
    time.sleep(0.5)
    print 47 * '-'
    print '\t\x1b[1;94mSubhan Of Fcebook\x1b[1;91m'
    print 47 * '-'
...
def n_s():
    ...
    time.sleep(0.5)
    print 47 * '-'
    print '\t\x1b[1;94mSubhan Of Facebook\x1b[1;91m'
    print 47 * '-'
